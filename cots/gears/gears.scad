...
//spur_gear (modul=1, tooth_number=25, width=5, bore=20, pressure_angle=20, helix_angle=20, optimized=true);

//spur_gear (modul=1, tooth_number=25, width=5, bore=5, pressure_angle=20, helix_angle=20, optimized=true);

//spur_gear (modul=1, tooth_number=50, width=5, bore=20, pressure_angle=20, helix_angle=20, optimized=true);
